...
plt.plot(dat[:,0]/xscale, dat[:,5], '.-', label=r'$m_1$')
plt.plot(dat[:,0]/xscale, dat[:,6], '.-', label=r'$m_2$')
plt.legend()
# %%
...
plt.plot(dat[:,0]/xscale, dat[:,7], '.-', label=r'$simple$')
plt.plot(dat[:,0]/xscale, dat[:,8], '.-', label=r'$full$')
plt.legend()
# %%
