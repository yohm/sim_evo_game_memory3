...
def make_plot(s_space, sigma_out_b, y_key, outfilepath=None, legend_loc=None):
  ...
  ax1.set_xlabel("relative mutaiton probability, $r$")
...
# %%
make_plot([2,2], 3.0, 'cooperation_level', 'm2_cooperation_level.pdf', 'lower right')

# %%
make_plot([2,2], 3.0, 'efficient_fraction', 'm2_efficient_fraction.pdf')

# %%
make_plot([2,2], 3.0, 'defensible_fraction', 'm2_rival_fraction.pdf')

# %%
make_plot([2,2], 3.0, 'friendly_rival_fraction', 'm2_friendly_rival_fraction.pdf')

# %%
make_plot([2,2], 30.0, 'cooperation_level', 'm2_cooperation_level_sigma_out_30.pdf', 'lower right')
make_plot([2,2], 30.0, 'efficient_fraction', 'm2_efficient_fraction_sigma_out_30.pdf')
make_plot([2,2], 30.0, 'defensible_fraction', 'm2_rival_fraction_sigma_out_30.pdf')
make_plot([2,2], 30.0, 'friendly_rival_fraction', 'm2_friendly_rival_fraction_sigma_out_30.pdf')
...
def plot_mem_length(s_space, sigma_out_b, benefit, outfilepath=None):
  ...
  if s_space[0] == 1:
    ...
    ax1.plot([0, 1], [1.0, 1.0], color='gray', linestyle='dotted')
  elif s_space[0] == 3:
...
def plot_mem_length_both(s_space, benefit, outfilepath=None):
  ...
  if s_space[0] == 1:
    ...
    raise ValueError("s_space[0] must be 1 or 2 or 3")
...
plot_mem_length_both([2,2], 3.0, 'm2_memory_length.pdf')
# %%
plot_mem_length([2,2], 3.0, 3, 'm2_memory_length_sigma_out_3.pdf')

# %%
plot_mem_length([2,2], 30.0, 3, 'm2_memory_length_sigma_out_30.pdf')
# %%
